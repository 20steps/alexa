...
Feature: Manage books and their reviews
  ...
  Scenario: Create a book
    ...
    And I send a "POST" request to "/bricks/api/rest/twentysteps/alexa/books" with body:
    """
    {
      "isbn": "9781782164104",
    ...
    """
    {
        "@context": "\/bricks\/api\/rest\/contexts\/Book",
        "@id": "\/bricks\/api\/rest\/twentysteps\/alexa\/books\/1",
        "@type": "Book",
        "id": 1,
        "isbn": "9781782164104",
        "title": "Persistence in PHP with the Doctrine ORM",
  ...
  Scenario: Retrieve the book list
    ...
    And I send a "GET" request to "/bricks/api/rest/twentysteps/alexa/books"
    ...
    {
        "@context": "\/bricks\/api\/rest\/contexts\/Book",
        "@id": "\/bricks\/api\/rest\/twentysteps\/alexa\/books",
  ...
  Scenario: Throw errors when a post is invalid
    ...
    """
    {
      "@context": "\/bricks\/api\/rest\/contexts\/ConstraintViolationList",
