<?php
	...
	use APIAI\Request\IntentRequest as APIAIIntentRequest;
	...
	class UptimeRobotModule extends AbstractModule {
		...
		/**
		 * @param APIAIIntentRequest $intentRequest
		 * @param User|null $user
		 * @return APIAIResponse
		 */
		public function processAPIAIIntent(APIAIIntentRequest $intentRequest, $user) {
